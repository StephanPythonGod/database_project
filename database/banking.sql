...
ALTER TABLE conversation ADD COLUMN pk BIGSERIAL NOT NULL PRIMARY KEY;
 
CREATE INDEX idx_user_trans ON TRANSACTION_OUT (user_id);

CREATE VIEW Loans AS SELECT * FROM bankaccount WHERE volume <0;